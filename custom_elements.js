...
rtl.module("program",["System","JS","Web"],function () {
  ...
  this.buttonClicked = function (event) {
    var Result = false;
    $mod.textLabel.innerHTML = ("Hello " + pas.JS.ToString($mod.textField["value"])) + "!";
    Result = false;
    return Result;
  };
  $mod.$main = function () {
    $mod.textLabel = document.getElementById("label");
    $mod.textField = document.getElementById("field");
    document.getElementById("button").onclick = $mod.buttonClicked;
  };
});
