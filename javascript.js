...
rtl.module("program",["System","JS"],function () {
  ...
  $mod.$main = function () {
    $mod.foo = new Object();
    $mod.bar = pas.JS.New(["name","thomas","age",18]);
    $mod.baz = Object.create($mod.bar);
    $mod.qux = Object.create($mod.bar,pas.JS.New(["property1",pas.JS.New(["value",42,"writable",false])]));
  };
});
